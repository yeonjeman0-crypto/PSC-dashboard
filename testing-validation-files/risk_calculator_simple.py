"""
Maritime Risk Calculator - Simplified Version
Core risk calculation functionality without heavy visualization dependencies
"""
...
class RiskCalculator_Maritime:
    ...
    def display_risk_matrix_text(self):
        ...
        print("\n🔥 5×5 Maritime Risk Assessment Matrix")
        print("=" * 60)
...
def main():
    ...
    try:
        ...
        if not high_risk_vessels:
            print("✅ No critical risk vessels found!")
